@section('start3')
    <div class="container">
        <div class="text-center">
            <h3 class="section-heading text-uppercase">Ropa para bebe</h3>
        </div>
        ...
        <div class="row custom-products-section">
            ...
            <div id="carouselExampleControls" class="carousel" data-bs-ride="false">
                ...
                <div class="carousel-inner custom-carousel-inner">
                    ...
                    @foreach($products->slice(15, 19) as $product)
...
@section('makeOrderScript3')
    <script>
        let multipleCardCarousel3 = document.querySelector("#carouselExampleControls");
        if (window.screen.width >= 576 || window.screen.width >= 1200) {
            new bootstrap.Carousel(multipleCardCarousel3, {interval: false,});
            ...
            $("#carouselExampleControls .carousel-control-next").on("click", function () {
                ...
                if (window.screen.width >= 1200) {
                    $(multipleCardCarousel3).removeClass("slide")
